...
export const PublicNavbar: React.FC<PublicNavbarProps> = ({
  ...
  // Checking out a single seller's cart — this is that seller's storefront checkout,
  // so the general "browse everyone" and "portal home" exits have no business here.
  ...
  return (
    <header className="public-navbar public-navbar--fixed">
      <div className="public-navbar-inner" ref={menuRef}>
        ...
        {shopScoped ? (
          <div className="public-navbar-brand public-navbar-brand--center">
            {logoSrc ? (
        ...
        <div className="public-navbar-actions">
          <nav className="public-navbar-desktop-links" aria-label="Marketplace links">
            ...
            <Link to={shopScoped ? `/visit?shop=${singleSellerSlug}` : '/visit'} className="public-navbar-link">
              Visit church
            </Link>
            <Link
              to="/market/chat"
